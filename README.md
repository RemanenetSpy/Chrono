...
# Chronos: Time Capsule Social

> "Capturing the fragments of today for the clarity of tomorrow."

**Chronos** is a minimalist digital sanctuary designed for intentional reflection. It allows you to compose letters and attach "visual echoes" (photos) to be delivered to your future self. By locking memories behind a temporal gate, Chronos transforms social posting into a private ritual of mindfulness.
...
- **Compose Across Time**: Write rich, serif-styled letters to the future.
...
- **The Vault**: A curated gallery of your pending and revealed history, styled as an elegant stationery collection.
...
## 🎨 Design Philosophy: "Parchment & Ink"

Chronos moves away from the aggressive "tech" aesthetic of modern social media. It utilizes:
- **Warm Light Themes**: A parchment-inspired background (`#fdfbf7`) that is easy on the eyes and feels tactile.
- **Literary Typography**: The use of *EB Garamond* provides a classic, timeless feel for your most important thoughts.
- **Minimalist Animation**: Subtle "fade-up" transitions and fine-line borders that mimic high-quality stationery.
- **Atmospheric Depth**: A soft grain overlay to give the digital interface a physical, paper-like soul.

## 🛠️ Built With

- **React 19**: For a fluid, component-based composition.
- **Tailwind CSS**: For a bespoke, responsive utility-first design.
- **SubtleCrypto API**: For industry-standard, hardware-accelerated encryption.
- **Google Fonts**: Specifically *EB Garamond* and *Inter*.
